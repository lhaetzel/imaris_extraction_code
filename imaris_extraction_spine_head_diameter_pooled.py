#head diameters pooled by genotype to make histogram
...
#loop over each cell analyzed and sort recorded head diameter lengths into lists
#initialize lists
HETD2_neg_Results = []
HETD2_pos_Results = []
WTD2_neg_Results = []
...
for i in range(len(folder_list)):
    ...
    if folder_list[i][1:-11] in HETD2_neg_List:
        HETD2_neg_Results.extend(Spine_Head_Diameter_List)
    
    elif folder_list[i][1:-11] in HETD2_pos_List:
        HETD2_pos_Results.extend(Spine_Head_Diameter_List)
    
    elif folder_list[i][1:-11] in WTD2_neg_List:
        WTD2_neg_Results.extend(Spine_Head_Diameter_List)
    
    elif folder_list[i][1:-11] in WTD2_pos_List:
        WTD2_pos_Results.extend(Spine_Head_Diameter_List)
...
Results_df.to_excel(r'/Users/lhaetzel/Desktop/Grad School/Rotations/Bateup Lab/Imaris_Export/Spine_Part_Head_Diameter_pooledbygenotype.xlsx', index = False)
