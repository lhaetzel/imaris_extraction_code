...
Master_df = pd.DataFrame(columns = ['Spine Part Mean Diameter Ground', 'Spine Part Mean Diameter Head', 'Spine Part Mean Diameter Neck', 'ID', 'cell number', 'animal number','genotype'])
...
for i in range(len(folder_list)):
    ...
    Spine_Part_Diameter_df = Spine_Part_Diameter_df.drop(columns = ['Unit', 'Category', 'Collection', 'Depth', 'Level', 'Time', 'FilamentID'])
...
#export to excel
Master_df.to_excel(r'/Users/lhaetzel/Desktop/Grad School/Rotations/Bateup Lab/Imaris_Export/Spine_Part_Diameter_by_individual_spines.xlsx', index = False)
